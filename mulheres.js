...
const conectaBandoDeDados = require('./bancoDeDados')// aqui estou ligando ao arquivo banco de dados
conectaBandoDeDados()//aqui estou chamando a função que conecta a o banco de dados
...
async function corrigeMulher(request, response) {
    try{
        ...
        response.jason(mulherAtualizadaNoBancoDeDados)  
    } catch(erro) {
        console.log(erro)
    }
}
